...
public class States {
  ...
  public static final SuperstructureScoringState CUBE_NODE_LOW =
      new SuperstructureScoringState(Positions.CUBE_NODE_LOW, IntakeState.OUTTAKE_CUBE);
  ...
  public static final SuperstructureScoringState CONE_NODE_LOW =
      new SuperstructureScoringState(Positions.CONE_NODE_LOW, IntakeState.OUTTAKE_CONE);
